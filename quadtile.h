...
public:
	...
	vector<quadtile*> calculatesubtiles(glm::vec3 cameraPos, int zoomlevel, float delta = 1.35);
	vector<quadtile*> calculatesubtiles1(glm::vec3 cameraPos, int zoomlevel, float delta = 1.25);
